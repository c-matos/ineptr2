...
[ineptR](https://github.com/c-matos/ineptR), with a new interface, fewer
dependencies, and many breaking changes. It was released as a separate
package so that existing ineptR workflows continue to work, allowing
users to migrate at their own pace.
...
- [Get
  started](https://c-matos.github.io/ineptr2/articles/get_started.html)
...
- [What changed from
  ...
  differences from the ineptR package.
